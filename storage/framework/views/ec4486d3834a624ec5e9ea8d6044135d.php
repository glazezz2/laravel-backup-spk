...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <h4><a href="<?php echo e(route('home')); ?>"><span>SPK</span></a></h4>
        <!-- Menu links -->
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            links.forEach(link => {
                ...
                if (href && currentPath.includes(href.replace('<?php echo e(url("/")); ?>', ''))) {
...
</html><?php /**PATH E:\laragon\www\spk-app\resources\views/layout.blade.php ENDPATH**/ ?>